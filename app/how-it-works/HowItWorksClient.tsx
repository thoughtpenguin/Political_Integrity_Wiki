    ...
    <div className="container animate-fade-in" style={{ maxWidth: 800 }}>
      ...
      <section className="card" style={{ marginBottom: '1.5rem' }}>
        ...
        <ol style={{ paddingLeft: '1.25rem', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
          ...
          <li><strong>Admins can &quot;pin&quot;</strong> a proposal to lock it as verified, awarding {config.pinProposalAuthorReward} points to the poster and {config.pinProposalUpvoterReward} to upvoters.</li>
        </ol>
      </section>
      ...
      <section className="card" style={{ marginBottom: '1.5rem' }}>
        ...
        <ul style={{ paddingLeft: '1.25rem', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
          ...
          <li><strong>Pinned proposals:</strong> The poster gets {config.pinProposalAuthorReward} points and upvoters get {config.pinProposalUpvoterReward} points (minus already earned).</li>
